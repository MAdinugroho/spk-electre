			...
			<div class="col-md-10 ml-auto mr-auto">
				<div class="card ">
					<div class="card-header">
						<div class="card-title">Ubah Kecamatan</div>
						<div class="card-category">Ubah nama kecamatan</div>
					</div>
					<div class="card-body">
						<form method="post">
							...
							<div class="form-group row">
								...
								<div class="col-sm-4">
									<input type="text" class="form-control form-control-round" placeholder="Masukan Nama Kecamatan" name="nama_alternatif" value="<?php echo $alt->nama_alternatif; ?>">
								</div>
							</div>
