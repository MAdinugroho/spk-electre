              ...
              <div class="dropdown-menu dropdown-menu-xl">
                <div class="dropdown-menu-inner">
                  ...
                  <a href="<?= base_url('homeAlternatif'); ?>" class="media d-flex align-items-center">
                    ...
                    <div class="media-body ml-3">
                      <h6 class="heading text-primary mb-md-1">List Kecamatan</h6>
                      <p class="description d-none d-md-inline-block mb-0">Kecamatan yang sudah ditambahkan ke sistem ini</p>
                    </div>
                  </a>
                  <a href="<?= base_url('homeNilaiAhir'); ?>" class="media d-flex align-items-center">
                    ...
                    <div class="media-body ml-3">
                      ...
                      <p class="description d-none d-md-inline-block mb-0">Hasil Perhitungan dari metode ELECTRE</p>
                    </div>
                  </a>
                </div>
              </div>
    ...
    <div class="container">
      ...
      <div class="row align-items-center justify-content-md-between">
        <div class="col-md-6">
          <div class="copyright">
            &copy; 2019
            <a href="https://www.creative-tim.com" target="_blank">Adinugroho</a>.
          </div>
        </div>
      </div>
    </div>
