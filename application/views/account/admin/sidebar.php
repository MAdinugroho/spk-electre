			...
			<div class="sidebar-wrapper scrollbar scrollbar-inner">
				<div class="sidebar-content">
					...
					<ul class="nav nav-primary">
						<li class="nav-item <?php if($view_name=='account/admin/dashboard'){echo 'active';}?>">
						...
						<div class="clearfix"></div>
						<li class="nav-item <?php if($view_name=='account/admin/createuser' || $view_name=='account/admin/listuser'){echo'active';}?>">
							<a data-toggle="collapse" href="#sidebarLayouts">
								<i class="fas fa-th-list"></i>
								<p>Kelola User</p>
								<span class="caret"></span>
							</a>
							<div class="collapse<?php if($view_name=='account/admin/createuser' || $view_name=='account/admin/listuser'){echo'.show';}?>" id="sidebarLayouts">
								<ul class="nav nav-collapse">
									<li>
